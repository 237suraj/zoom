...
export default class QuickSearch extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            OriginalProduct: this.props.ProductData,
            costA: 0,
            costB: 0,
            costC: 0,
            costD: 0,
    ...
    async componentDidMount() {
        await this.getCostCount(this.state.ProductData)
        this.setState({
            cost: {
                ...
                <div className="row">
                    <div className="col-l-16 search-top-area">
                        <div className="search-header mb5">
                            <h1 className="search_title ptop pb5 fn mb0 mt10">{this.props.title}</h1>
                        </div>
                    </div>
